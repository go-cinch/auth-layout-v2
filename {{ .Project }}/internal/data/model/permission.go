...
// When the optional Action module is disabled, the core RBAC flows (role/user/permission)
// still need the Action model to resolve permission codes into resources/menus/buttons.

const TableNameAction = "permission"

// Action mapped from table <permission>
type Action struct {
